...
- **CLI Agent Integration** (`server/src/codebot/cli_agents/`): Delegates coding to Codex, OpenAI Codex CLI, Gemini CLI via subprocess/SDK
...
| LLM | LiteLLM, Codex Agent SDK, RouteLLM, Langfuse |
