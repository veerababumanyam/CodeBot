"""ToolsCreatorAgent -- stub for tool building functionality.

Minimal implementation registered as AgentType.TOOL_BUILDER.
Full tool building functionality will be implemented in Phase 11.
...
SYSTEM_PROMPT = """\
You are the Tools Creator agent. Full functionality will be implemented in Phase 11.
"""
...
class ToolsCreatorAgent(BaseAgent):
    """Stub agent for tool building -- full implementation in Phase 11.
    ...
    async def act(self, plan: dict[str, Any]) -> PRAResult:
        ...
        return PRAResult(
            is_complete=True,
            data={"message": "Tool building deferred to Phase 11", "stub": True},
        )
    ...
    async def review(self, result: PRAResult) -> AgentOutput:
        ...
        return AgentOutput(
            ...
            state_updates={"tools_creator_output": result.data},
            review_passed=True,
        )
