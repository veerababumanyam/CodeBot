...
TIER 3 — Depends on Tier 2:
  - CLI Agent Bridge (Claude Code Agent SDK, Codex CLI subprocess, Gemini CLI subprocess)
...
(Claude Code SDK), sandbox execution, first end-to-end pipeline from PRD to tested code.
...
**Research needed:** Claude Code SDK integration, Codex CLI subprocess management.
...
| Phase 3 | Claude Code SDK integration | Relatively new SDK; error handling and subprocess lifecycle need validation |
