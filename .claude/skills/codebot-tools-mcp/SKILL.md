...
- **stdio** -- default for CLI integrations (Claude Code, Codex CLI, Gemini CLI)
...
CLI agents (Claude Code, Codex CLI, Gemini CLI) are integrated via a separate CLI agent
