  ...
  apps/
    server/              # FastAPI Python backend (core platform)
      src/codebot/
        ...
        cli_agents/      # CLI Agent Bridge (Claude Code SDK, Codex, Gemini subprocess)
...
- **Claude Code Agent SDK** — Direct integration for autonomous coding (in-process)
...
- CLI agents (Claude Code, Codex, Gemini CLI) integrate directly — they bypass the gateway
