...
| 06-02-01 | 02 | 2 | PIPE-01 | integration | `uv run pytest tests/integration/test_pipeline_e2e.py -x` | ❌ W0 | ⬜ pending |
| 06-02-02 | 02 | 2 | PIPE-02 | unit | `uv run pytest tests/unit/pipeline/test_parallel_phases.py -x` | ❌ W0 | ⬜ pending |
| 06-02-03 | 02 | 2 | PIPE-03 | unit | `uv run pytest tests/unit/pipeline/test_gates.py -x` | ❌ W0 | ⬜ pending |
| 06-02-04 | 02 | 2 | PIPE-05 | integration | `uv run pytest tests/integration/test_temporal_durability.py -x` | ❌ W0 | ⬜ pending |
| 06-02-05 | 02 | 2 | PIPE-06 | integration | `uv run pytest tests/integration/test_pipeline_resume.py -x` | ❌ W0 | ⬜ pending |
