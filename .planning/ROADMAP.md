...
Plans:
- [ ] 01-01: Monorepo scaffolding (Turborepo, pyproject.toml, package.json, turbo.json, Makefile)
- [ ] 01-02: Docker Compose dev stack and database schemas (PostgreSQL, Redis, NATS, LanceDB, SQLAlchemy models, Alembic)
- [ ] 01-03: Shared types and event bus (Pydantic models, TypeScript shared-types, NATS JetStream integration)
